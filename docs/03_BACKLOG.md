...
| P4-2 | TODO | Adicionar e aplicar skills `vercel-react-best-practices`, `web-design-guidelines` e `frontend-design` (referência: `skills.sh`) no ciclo de frontend | Reduzir aparência de app “gerado por IA” e elevar padrão visual/técnico |
