...
| P5-44 | TODO | Revisar atalhos restantes do hub e migrar para IDs explícitos quando crítico | Padronizar estratégia de links internos para documentação operacional |
