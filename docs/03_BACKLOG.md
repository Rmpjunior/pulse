...
| P5-53 | TODO | Expandir micro-check para validar links de arquivo no índice operacional (`docs/04_SESSION_LOG.md#...`) | Cobrir regressão além de âncoras locais do README |
