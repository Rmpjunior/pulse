...
| ID | Status | Task | Why |
|---|---|---|---|
| P2-1 | TODO | Define subscription gating matrix in code (Free vs Plus) | Prepare premium flows |
...
| P2-4 | TODO | Implement plan-gated limits (sections limit, custom colors, watermark removal) | Match Keepo free/plus behavior |
...
| ID | Status | Task | Why |
|---|---|---|---|
| P3-1 | TODO | Add richer social/media embed coverage and validation UX | Better creator flexibility |
| P3-2 | TODO | Add public page performance + accessibility hardening pass | Quality and trust |
