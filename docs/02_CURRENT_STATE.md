...
- `P6-13` concluído: entrada obsoleta `plugins.entries.google-antigravity-auth` removida da config OpenClaw; `openclaw models list` não exibe mais warning de plugin removido
